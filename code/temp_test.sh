...
--multi_anchor \
--conf_thresh 0.3 \
--weight "../yolov2_tiny_bnn_28_0.47.pth" \
--root "/media/HDD4/personal_files/liyanchen/gen1"
...
# --weight "/media/HDD2/personal_files/zhanghu/PyTorch_YOLO-Family_logs/logs/retrain/log_20230302_100753/yolov2_tiny_bnn_15_0.57.pth" \
# --root "/media/HDD4/personal_files/zhanghu/gen1"
