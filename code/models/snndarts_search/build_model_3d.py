...
class AutoMatching(nn.Module):
    def __init__(self, num_layers, filter_multiplier=8, block_multiplier=2, step=3, cell=cell_level_search.Cell,p=0.0):
        ...
        # self.stem0 = ConvBR(8, self._num_end, 3, stride=1, padding=1)
